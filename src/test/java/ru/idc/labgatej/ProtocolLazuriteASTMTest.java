...
import ru.idc.labgatej.drivers.lazurite.ProtocolLazuriteASTM;
import ru.idc.labgatej.model.PacketInfo;
import ru.idc.labgatej.model.ResultInfo;

import java.util.List;

public class ProtocolLazuriteASTMTest {

	@Test
	public void testString() {
		ProtocolLazuriteASTM astm = new ProtocolLazuriteASTM();
		String t = "R|1|^^^readonly|0.060|OD||RW||F||||20040205151556|DSX0055";
